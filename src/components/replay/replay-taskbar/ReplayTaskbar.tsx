                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    {currentTask.examples?.map((example: any, index: number) => (
                      <Card key={index} className="overflow-hidden border shadow-sm bg-white">
                        <div className="bg-gray-50 px-4 py-2 border-b">
                          <h4 className="text-sm font-medium text-foreground">Example {index + 1}</h4>
                        </div>
                        <div className="p-4">
                          <pre className="text-xs bg-gray-50 p-3 rounded-lg font-mono border whitespace-pre-wrap break-words overflow-hidden">
